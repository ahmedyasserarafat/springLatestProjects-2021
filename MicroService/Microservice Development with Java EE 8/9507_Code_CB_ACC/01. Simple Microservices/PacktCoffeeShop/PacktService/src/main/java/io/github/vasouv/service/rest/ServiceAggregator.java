...
public class ServiceAggregator {
    ...
    private final String CUSTOMER_SERVICE_URI = "http://localhost:8085/PacktCustomer/packt-customers";
    private final String ORDER_SERVICE_URI = "http://localhost:8086/PacktOrder/packt-orders";
